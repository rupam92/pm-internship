  ...
  return (
    <div ref={languageDropdownRef} className="relative inline-block">
      ...
      <div className="flex items-center w-20 h-10 relative">
        <div className="bg-[var(--primary-sky)] w-8 h-8 flex items-center justify-center rounded-full absolute left-3 z-10">
          <FaGlobeAmericas className="text-white" />
        </div>

        <button
          className="absolute end-0 w-14 flex items-center fw-semibold justify-end !bg-[#fff] text-[var(--primary-sky)] px-1 py-1 shadow-md"
